      ...
      <!-- Main -->
        <div id="main">
          <div class="inner">
            ...
            <header id="header">
              <div class="logo">
                <a href="index.html">Course Android</a>
              </div>
            </header>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="left-content">
                      <h1>Course 2</h1>
                      <h4>Install Java Development Kit</h4>
                  ...
                  <div class="col-md-6">
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/bmuOlpfUVYw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
                </div>
              </div>
            </section>
      ...
      <!-- Sidebar -->
        <div id="sidebar">
          <div class="inner">
            ...
            <nav id="menu">
              <ul>
                <li><a href="courseAndroid">Persiapan Awal - Install Android Studio</a></li>
                <li><a href="courseAndroid2">Install Java Development Kit</a></li>
                <li><a href="courseAndroid3">Memulai Membuat Project Di Android Studio</a></li>
                <li><a href="courseAndroid4">Membuat Aplikasi Hello World Pertama</a></li>
              </ul>
            </nav>
