          ...
          <div class="inner">
            ...
            <section class="top-image">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
                  <img src="<?php echo base_url('assets/images/top-image.jpg'); ?>">
            ...
            <section class="left-image">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-6">
                    <img src="<?php echo base_url('assets/images/left-image.jpg'); ?>">
                  </div>
                  <div class="col-md-6">
            ...
            <section class="right-image">
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-6">
                  <img src="<?php echo base_url('assets/images/right-image.jpg'); ?>">
                  </div>
                </div>
              </div>
            </section>
